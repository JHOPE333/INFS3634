...
public class module2question4 extends android.support.v4.app.Fragment  {
...
// Inflate the layout for this fragment
    ...
    public class getQuestion8 extends AsyncTask<Integer, Void, String> {
    ...
    class checkAnswer8 extends AsyncTask <Integer, Void, String> {
        @Override
        protected String doInBackground(Integer... integers) {
