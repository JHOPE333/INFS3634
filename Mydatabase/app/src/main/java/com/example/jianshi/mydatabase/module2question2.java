...
public class module2question2 extends android.support.v4.app.Fragment {
...
// Inflate the layout for this fragment
        ...
        radioButton1.setText("Insert into TableName (2,’Bob’)");

        radioButton2 = view.findViewById(R.id.radioButton2);
        radioButton2.setText("None of the above ");

        radioButton4 = view.findViewById(R.id.radioButton4);
        radioButton4.setText("Insert into TableName Values (2, ‘Bob’)");

        radioButton2 = view.findViewById(R.id.radioButton3);
        radioButton2.setText("Insert into TableName Values 2,’Bob’");
    ...
    public class getQuestion6 extends AsyncTask<Integer, Void, String> {
    ...
    class checkAnswer6 extends AsyncTask <Integer, Void, String> {
        @Override
        protected String doInBackground(Integer... integers) {
        ...
        protected void onPostExecute(String answer) {
            ...
            try {
                if (radioButton.getText().toString().equals(answer)) {
                    ...
                    loadFragment(new module2question3());
                } else {
