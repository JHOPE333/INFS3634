...
public class module3question2 extends android.support.v4.app.Fragment  {
...
// Inflate the layout for this fragment
        ...
        radioButton1.setText("executeUpdate");

        radioButton2 = view.findViewById(R.id.radioButton2);
        radioButton2.setText("executeQuery ");
    ...
    public class getQuestion11 extends AsyncTask<Integer, Void, String> {
    ...
    class checkAnswer11 extends AsyncTask <Integer, Void, String> {
        @Override
        protected String doInBackground(Integer... integers) {
