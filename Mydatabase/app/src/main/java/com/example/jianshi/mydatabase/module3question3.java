...
public class module3question3 extends android.support.v4.app.Fragment  {
...
// Inflate the layout for this fragment
        ...
        radioButton1.setText("Resultset.getString(query);");

        radioButton2 = view.findViewById(R.id.radioButton2);
        radioButton2.setText("Resultset.getText(query);");

        radioButton4 = view.findViewById(R.id.radioButton4);
        radioButton4.setText("Resultset.toString(query);");

        radioButton3 = view.findViewById(R.id.radioButton3);
        radioButton3.setText("ResultSet.getString();");
        ...
        correct.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                loadFragment(new module3question4());
            }
        });
    ...
    public class getQuestion12 extends AsyncTask<Integer, Void, String> {
    ...
    class checkAnswer12 extends AsyncTask <Integer, Void, String> {
        @Override
        protected String doInBackground(Integer... integers) {
