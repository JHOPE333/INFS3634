...
public class module2question1 extends android.support.v4.app.Fragment {
...
// Inflate the layout for this fragment
        ...
        new getQuestion5().execute(5);

        // button that checks if ur choice is the right answer
        Checkbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new checkAnswer5().execute(5);
            }
        });
        return view;
    }
    //retrieves question 1
    public class getQuestion5 extends AsyncTask<Integer, Void, String> {
    ...
    class checkAnswer5 extends AsyncTask <Integer, Void, String> {
        @Override
        protected String doInBackground(Integer... integers) {
