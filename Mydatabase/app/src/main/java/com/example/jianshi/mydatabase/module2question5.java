...
public class module2question5 extends android.support.v4.app.Fragment {
...
// Inflate the layout for this fragment
        ...
        radioButton1.setText("statement = conn.createStatement(); statement.execute(\"INSERT INTO DRIVER VALUES (2,’Bob’ );\")");
        radioButton2 = view.findViewById(R.id.radioButton2);
        radioButton2.setText("statement.execute(\"INSERT INTO DRIVER VALUES (2,’Bob’ );\")\n ");

        radioButton4 = view.findViewById(R.id.radioButton4);
        radioButton4.setText("con.createStatement().execute()");

        radioButton2 = view.findViewById(R.id.radioButton3);
        radioButton2.setText("Statement.execute();");
    ...
    public class getQuestion9 extends AsyncTask<Integer, Void, String> {
    ...
    class checkAnswer9 extends AsyncTask <Integer, Void, String> {
        @Override
        protected String doInBackground(Integer... integers) {
