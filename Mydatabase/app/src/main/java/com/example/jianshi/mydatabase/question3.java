...
// Inflate the layout for this fragment
        ...
        radioButton1.setText("Null Pointer Exception");

        radioButton2 = view.findViewById(R.id.radioButton2);
        radioButton2.setText("Database Exception");

        radioButton4 = view.findViewById(R.id.radioButton4);
        radioButton4.setText("SQL Exception");
        ...
        new getQuestion3().execute(3);

        // button that checks if ur choice is the right answer
        Checkbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new checkAnswer3().execute(3);
            }
        });
        Log.i(TAG, "question 3 initialised");
        return view;
    ...
    //retrieves question 1
    public class getQuestion3 extends AsyncTask<Integer, Void, String> {
    ...
    class checkAnswer3 extends AsyncTask <Integer, Void, String> {
        @Override
        protected String doInBackground(Integer... integers) {
